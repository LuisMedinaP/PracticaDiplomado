...
namespace LuisMedinaColegio.Controllers
{
    public class ProfesorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nombre,Apellido")] Profesor profesor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nombre,Apellido")] Profesor profesor)
        {
            if (ModelState.IsValid)
            {
